...
class ThinIceEnv(gym.Env):
    ...
    def __init__(self, render_mode=None, path_to_level='Text files\Level 1.txt'):
...
if __name__ == "__main__":
    env = gym.make('thin-ice-v0', render_mode='human', path_to_level='Text files\Level 1.txt')
